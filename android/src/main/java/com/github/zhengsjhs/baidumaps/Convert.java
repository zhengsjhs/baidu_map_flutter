...
class Convert {
  ...
  static MyLocationData toMyLocationData(Object o) {
    final Map<?, ?> data = toMap(o);
    final MyLocationData.Builder builder = new MyLocationData.Builder();
    builder.latitude(toFloat(data.get("lat")));
    builder.longitude(toFloat(data.get("lng")));
  ...
  static Object toJson(MyLocationData position) {
    if (position == null) {
      return null;
    }
    final Map<String, Object> data = new HashMap<>();
    data.put("lat", position.latitude);
    data.put("lng", position.longitude);
    data.put("direction", position.direction);
    data.put("speed", position.speed);
    return data;
  }
  ...
  static void interpretGoogleMapOptions(Object o, BaiduMapOptionsSink sink) {
    final Map<?, ?> data = toMap(o);
